            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 justify-center">
                    {contatos.map((contato) => (
                        <div key={contato.titulo} className="flex flex-col px-5 py-6 md:py-4 mx-5 bg-zinc-800 border rounded-xl border-zinc-900/5
                            ...
                            <a href={contato.link} target="_blank" rel="noopener noreferrer" className="flex items-center justify-start gap-2">
                                ...
                                <div className="flex flex-col">
                                    <p>{contato.titulo}</p>
                                    {contato.titulo === "Email" && <p className="text-zinc-400 text-sm">{contato.meuGmail}</p>}
                                </div>
                            </a>
                        </div>
                    ))}
